...
Платформа подготовки, проверки, согласования и публикации контента с календарём,
источниками, исследовательскими разделами и ИИ-инструментами. Это не CRM и не система
ведения юридических дел; финальную юридическую оценку выполняет человек.
...
| `/app/library` | А6 | Референсы и сохранённая коллекция материалов |
| `/app/rss` | А6 | Юридические инфоповоды: для вас, сохранённые, использованные и скрытые |
...
Маршруты показывают production surface, но не одинаковую степень внешней готовности.
Telegram, VK, AI, поиск, RSS, анализ сайтов, почта и uploads требуют конфигурации; наличие
экрана не доказывает live-доставку, полноту данных или качество результата.
...
- **Telegram/VK API** — интеграционные контуры; live-возможность определяется capability
  registry, credentials и проверкой разрешений, неподдерживаемый путь завершается fail-closed
...
3. **Демонстрационные сцены** — визуальные примеры интерфейса. Их цифры не являются
   клиентским кейсом, фактической аналитикой или доказательством внешней доставки
