...
import { jsonLdHtml, listHostedArticles, loadHostedSite, sectionJsonLd } from "@/lib/site-hosted/service";
...
export default async function HostedIndexPage({ params }: Params) {
  ...
  return (
    <main id="main">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: jsonLdHtml(sectionJsonLd(site)) }} />
