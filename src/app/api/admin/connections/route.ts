...
import { loadAdminConnections } from "@/lib/admin-operations-data";
...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json(await loadAdminConnections(getPool(), req.nextUrl.searchParams), { headers: { "Cache-Control": "no-store" } });
  } catch {
