...
vi.mock("@/lib/admin-operations-data", () => ({ loadAdminAiSpend: mocks.load }));
...
const request = () => new NextRequest("http://localhost/api/admin/ai-spend?page=2&q=fixture");
...
describe("GET /api/admin/ai-spend real admin policy", () => {
