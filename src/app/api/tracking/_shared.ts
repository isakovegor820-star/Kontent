...
export function trackingApiError(error: unknown, requestId: string) {
  ...
  if (error instanceof TrackingServiceError) {
    const status: Record<TrackingServiceError["code"], number> = {
      ...
      verification_script_missing: 422,
      invalid_verification_method: 422,
      verification_file_missing: 422,
      verification_content_mismatch: 422,
      verification_redirect: 422,
      verification_access_denied: 422,
      not_found: 404,
