...
const CATEGORY_TERMS: Record<RssCatalogCategory, string[]> = {
  ...
  "Финансы": [
    ...
    "бюджет", "налог", "бухгалтер", "капитал", "страхов", "крипт", "биткоин",
    "блокчейн", "web3", "токен", "майнинг", "defi", "ethereum", "эфириум",
  ],
  "Право": [
    "прав", "юрид", "закон", "суд", "договор", "банкрот", "налог", "адвокат",
...
const RSS_CATALOG: CatalogRecord[] = [
  ...
  },
  {
    ...
    description: "Новости и разборы рынка криптовалют, Web3, регулирования и технологий.",
    category: "Финансы",
    language: "EN",
    featured: 9,
    tags: ["крипт", "биткоин", "блокчейн", "web3", "токен", "defi"],
  },
  {
    id: "cointelegraph",
    title: "Cointelegraph",
    url: "https://cointelegraph.com/rss",
    description: "Оперативные события крипторынка, блокчейна, DeFi и цифровых активов.",
    category: "Финансы",
    language: "EN",
    featured: 8,
    tags: ["крипт", "биткоин", "ethereum", "блокчейн", "web3", "defi"],
  },
  {
    id: "decrypt",
    title: "Decrypt",
    url: "https://decrypt.co/feed",
    description: "Понятные новости о криптовалютах, Web3, регулировании и цифровой культуре.",
    category: "Финансы",
    language: "EN",
    featured: 7,
    tags: ["крипт", "биткоин", "ethereum", "блокчейн", "web3", "токен"],
  },
  {
    id: "government",
