...
export const ADMIN_AUDIT_ACTION_LABELS: Readonly<Record<string, string>> = Object.freeze({
  ...
  "publication.admin.retried": "Администратор повторил публикацию",
  "publication.admin.rescheduled": "Администратор перенёс публикацию",
  "publication.admin.cancelled": "Администратор отменил публикацию",
