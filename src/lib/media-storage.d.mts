...
export function putMediaObject(input: { userId: number; sha256: string; extension: string; mimeType: string; body: Buffer; env?: NodeJS.ProcessEnv }): Promise<{ key: string; etag: string | null }>;
...
}): Promise<null | { kind: string; file_name: string; mime_type: string; bytes: number; data: Buffer }>;
