...
// (студия, автопилот, идеи для публикаций). Механика: инструкция в системный промпт + температура
...
export const MOODS: Record<string, Mood> = {
  ...
  bold: {
    ...
    prompt: [
      ...
      "Остроту создавай точным наблюдением и контрастом, а не хамством, унижением или кликбейтом. Мат регулируется отдельной настройкой публикации и прямым запросом пользователя: не запрещай и не цензурируй его, когда выбран свободный режим.",
