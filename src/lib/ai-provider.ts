...
export function buildSystemPrompt(p: GenerateParams): string {
  ...
  const lines = [
    ...
    "При конфликте правило с меньшим номером всегда важнее. Глобальная mainIdea не может заменить тему выбранного материала. Значения Auto можно уточнить командой, явно выбранные значения — нельзя.",
    "",
