...
const RULES = [
  ...
  { word: "Призыв", small: "без давления", bad: "только сегодня", good: "сохрани и проверь на следующем посте" },
] as const;

const CHECKS = ["Источник найден", "Обещаний нет", "Тон совпадает", "Стоп-фраз нет", "Призыв уместен"] as const;
