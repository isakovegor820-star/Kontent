...
const TABS: readonly {
...
}[] = [
  {
    ...
    tone: "text-info-text",
    purpose:
      "Поиск по собственной базе и публичному Telegram. Находи реальные каналы, публикации и тренды по любой теме.",
  },
  {
    routeId: "competitors",
    icon: Radar,
  ...
  },
  {
    ...
    tone: "text-fire-text",
    purpose:
      "Статистика за день, неделю, месяц или квартал — по своей базе, проверенным находкам из интернета и редакционной подборке.",
  },
];
