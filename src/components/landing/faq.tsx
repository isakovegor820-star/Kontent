...
const ITEMS: Qa[] = [
  ...
  },
  {
    ...
    a: "Сейчас работает Telegram. VK — следующая волна: мы начали именно с этих двух сетей, потому что их не поддерживает ни один глобальный сервис, а именно там сидит наша аудитория. Instagram, TikTok и YouTube — позже. Мы лучше сделаем две сети отлично, чем шесть кое-как.",
  },
  {
    icon: CalendarClock,
    q: "Продукт уже работает или это лист ожидания?",
    a: "Работает. Ранний доступ открыт прямо сейчас: подключаешь Telegram-канал, добавляешь конкурентов — и разведка, ИИ и автопилот уже внутри. Не работает пока одно: публикация в VK, её открываем следующей волной. Даты мы называем только на одну волну вперёд — так честнее, чем обещать всё и сразу.",
  },
  {
    icon: Users,
