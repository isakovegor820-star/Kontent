...
const ROWS: readonly Row[] = [
  {
    ...
    icon: Send,
    cells: [
      // Честно: публикация в VK ещё не построена. Ставить здесь галочку — значит делать
      // ровно то, за что мы ниже бьём Metricool («реклама обещает, справка говорит другое»).
      { value: "partial", note: "Telegram сейчас, VK — следующей волной" },
      { value: false },
      { value: false },
