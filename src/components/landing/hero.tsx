      ...
      <div className="relative mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-14 px-5 sm:px-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14 xl:gap-20">
        ...
        <div className="flex flex-col items-start">
          ...
          {/* Честная строка (ТЗ 6: честность лимитов и сроков — всегда).
              Про VK говорим здесь и сразу: публикация в VK ещё не построена, и обещать её
              рядом с кнопкой «Забрать ранний доступ» значило бы соврать на первом же экране —
              ровно в том, за что мы бьём Metricool в секции сравнения. */}
          <motion.p {...rise(0.58)} className="mt-4 text-[13px] leading-relaxed text-text-2">
            Без карты. Без пейволов. Telegram работает сейчас — VK подключаем следующей волной.
          </motion.p>
